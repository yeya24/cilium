...
func (s *scope) decrementSafely() {
	...
	s.counter--
	if s.counter < 0 {
		panic(fmt.Sprintf("unexpected negative scope counter value: %d", s.counter))
	}
}
...
func wrapContextFunc(fn func(string, func()) bool, focused bool) func(string, func()) bool {
	return func(text string, body func()) bool {
		...
		newScope := &scope{text: currentScope.text + " " + text, parent: currentScope, focused: focused, mutex: &sync.Mutex{}}
